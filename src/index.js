...
document.getElementById("timeRemaining").innerText = `${minutes}:${seconds}`;
  ...
  function showResults() {
    ...
    resultContainer.innerText =
      `You scored ${quiz.correctAnswers} out of ${quiz.questions.length} correct answers!`; // This value is hardcoded as a placeholder
  }
...
function restartQuiz() {
  ...
  /***************************************************************
   *  START QUIZ (BEGINNING)
   ***************************************************************/
  showQuestion();
  startTimer(); // ✔️ DAY 4 — iniciar temporizador al comenzar
